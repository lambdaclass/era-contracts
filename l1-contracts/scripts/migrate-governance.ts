...
async function main() {
    ...
    program
        ...
        .action(async (cmd) => {
            ...
            const erc20MigrationTx = l1Erc20Bridge.interface.encodeFunctionData('changeAdmin', [
            ...
            const l2Erc20BridgeCalldata = l2ERC20Bridge.interface.encodeFunctionData('changeAdmin', [
                aliasedNewGovernor
            ]);
